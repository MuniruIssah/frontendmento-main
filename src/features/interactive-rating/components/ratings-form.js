...
const RatingsForm = ({activeState,handleChange,handleSubmit}) => {
    return (
        <div className={'flex flex-col space-y-7 items-start'}>
            <div className={'h-10 w-10 md:h-12 md:w-12 rounded-full bg-[#7C8798]/10 w-auto flex justify-center items-center '}>
                <img src={star} className={'object-fit w-3 md:w-auto'} alt={'star'}/>
            </div>
            <div className={'flex flex-col space-y-3'}>
                <span className={'text-white text-2xl'}>How did we do?</span>
                <p className={'text-[#959EAC] text-[13px]'}>Please let us know how we did with your support request. All feedback is appreciated to help us improve our offering!</p>
            </div>
